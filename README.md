# Stormannsgal
The project is driven by megalomania
...
```bash
git clone https://github.com/Stormannsgal/stormannsgal-api.git
cd stormannsgal-api
```
...
chmod +x bin/stormannsgal

# Run the automated setup
./bin/stormannsgal setup
```
...
## Unsupported Management CLI via `./bin/stormannsgal`
